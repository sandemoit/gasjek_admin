                    ...
                    <form action="<?= base_url('/food/save') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Deskrispi Makanan</label>
                                    <input type="text" class="form-control <?= ($validation->hasError('food_desc')) ? 'is-invalid' : '' ?>" id=" exampleFormControlInput1" placeholder="Berikan deskripsi makanan" name="food_desc">
                    ...
                    ?>
                        ...
                        foreach ($foods as $row) : ?>
                            <tr id="<?= $row['id_food']; ?>">
                                ...
                                <td>
                                    <img src="../assets/foods/<?= $row['food_image']; ?>">

                                </td>

                                <td>

                                    <a style="margin-left: 15px;" href="<?= base_url() ?>/restaurant/edit_food/<?= $row['id_food']; ?>">
